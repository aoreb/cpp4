            ...
            Canvas {
                ...
                onPaint: {
                  ...
                  const maxTicks = 10
                    ...
                    if (pointsM1.length > 0) {
                        ...
                        context.moveTo(width/2 + step*pointsM1[0].x, height/2 - step*pointsM1[0].y)
                            ...
                            for (i = 1; i < pointsM1.length; i++) {
                                context.lineTo(width/2 + step*pointsM1[i].x, height/2 - step*pointsM1[i].y)
                            }
                    ...
                    if (pointsM2.length > 0) {
                        ...
                        context.moveTo(width/2 + step*pointsM2[0].x, height/2 - step*pointsM2[0].y)
                            ...
                            for (i = 1; i < pointsM2.length; i++) {
                                context.lineTo(width/2 + step*pointsM2[i].x, height/2 - step*pointsM2[i].y)
                            }
                    ...
                    if (coordsSetting) {
                        context.beginPath();
                        context.arc(width/2 + step*circleX1, height/2 - step*circleY1, 10, 0, Math.PI * 2);
                        ...
                        context.textAlign = "center"
                        context.fillText("1", width/2 + step*circleX1, height/2 - step*circleY1 + 5)

                        context.beginPath();
                        context.arc(width/2 + step*circleX2, height/2 - step*circleY2, 10, 0, Math.PI * 2)
                        ...
                        context.fillStyle = "#ffffff"
                        context.textAlign = "center"
                        context.fillText("2", width/2 + step*circleX2, height/2 - step*circleY2 + 5)
                     }
                  }
